...
class User:
    ...
    def set_parameters(self, model, beta=1):
        ...
        '''
        for param_model,param_user in zip(model.parameters(),self.model.parameters()): #取傳入 model 的 param * beta
            param_user.data += (1-beta)*param_user.data + beta * param_model
