...
from attacker import MyAttacker, RND
...
def get_args():
    ...
    parser.add_argument(
        ...
        "--input_file",
        type=str,
        default="target_nodes_list.txt",
        help="Target node file.",
    )
    parser.add_argument(
        "--data_path", type=str, default="./data/data.pkl", help="Input graph."
    )
    parser.add_argument(
        "--model_path",
        type=str,
        default="saved-models/gcn.pt",
        help="GNN model to attack.",
    )
